...
$firstName = $lastName = $age = $parentFirstName = $parentLastName = $parentPhone = $parentAddress = $parentID = $subjects = "";
$firstNameErr = $lastNameErr = $ageErr = $parentFirstNameErr = $parentLastNameErr = $parentPhoneErr = $parentAddressErr = $parentIDErr = $subjectsErr = "";
...
$conn = connectDB();
    ...
    // Insert data into A2parent table
    ...
    // Insert data into A2student table
    $stmt2 = $conn->prepare("INSERT INTO A2student (firstName, lastName, age, parentId) VALUES (?, ?, ?, ?)");
    $stmt2->bind_param("ssii", $firstName, $lastName, $age, $parentID);
    $stmt2->execute();
